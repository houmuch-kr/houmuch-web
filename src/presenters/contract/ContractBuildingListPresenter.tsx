...
import { ContractBuildingList, ContractType } from "~/types";
import { DataTable } from "~/components";

interface Props {
  data?: ContractBuildingList
  isLoading: boolean
}

const ContractBuildingListPresenter = ({ data, isLoading }: Props) => {
...
export default ContractBuildingListPresenter
